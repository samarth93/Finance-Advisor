          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Receive expense alerts via email</p>
              </div>
              <button
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Get monthly expense summaries</p>
              </div>
              <button
                onClick={() => toast('Notification settings coming soon!', { icon: 'ℹ️' })}
                className="bg-gray-200 relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"
        ...
        <div className="p-6">
          <div className="space-y-4">
            ...
            >
              ...
              <p className="text-sm text-gray-500">Upload expenses from CSV file</p>
            </button>
          </div>
        </div>
      </div>
